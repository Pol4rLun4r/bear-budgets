...
interface GetItemReferenceNotesInput {
    item_reference_id: number;
}

const getItemReferenceNotesRules = ({ item_reference_id }: GetItemReferenceNotesInput) => {
...
export default getItemReferenceNotesRules;
