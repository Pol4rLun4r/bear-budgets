...
import { resetReferenceLink, setReferenceLink } from "../../../../redux/itemForm/ReferenceLinkFormSlice.ts"
import { addLink, type ItemFormScope } from "../../../../redux/itemForm/itemFormSlice.ts";

const Form = ({ scope }: { scope: ItemFormScope }) => {
    const dispatch = useDispatch<AppDispatch>()
    const referenceLink = useSelector((state: RootState) => state.itemForm.referenceLinkForm[scope]);
