...
import { ItemFormScope, setReferenceField } from "../../../../../redux/itemForm/itemFormSlice";
...
const Input = ({ isLoader, options, combobox, handleChange, handleClearData, scope }: InputType) => {
    ...
    const description = useSelector((state: RootState) => state.itemForm.form[scope].item_reference.description);

    const isHasId = useSelector((state: RootState) => state.itemForm.form[scope].item_reference.id);
